        ...
        <div className="grid lg:grid-cols-[35%_65%] gap-8 md:gap-12">
          ...
          <div className="space-y-1">
            {services.map((service, index) => (
              ...
              >
                <div className="text-[#FF8A3D] text-2xl md:text-3xl font-bold w-12 flex-shrink-0 group-hover:text-[#2F80FF] transition-colors duration-300">
                  {service.number}
                </div>
                <div className="flex-1">
                  <h3 className="text-[17px] md:text-[19px] font-bold text-white mb-1 tracking-tight">
                    {service.title}
                  </h3>
                ...
                <div className="text-[#94A3B8] group-hover:text-[#2F80FF] transition-colors duration-300">
