      ...
      <div className="max-w-[1200px] mx-auto px-5 md:px-6 lg:px-8">
        <div className="grid lg:grid-cols-[45%_55%] gap-8 md:gap-12 items-center">
          <div className="space-y-5">
            <h2 className="text-[clamp(40px,4vw,52px)] font-bold text-white leading-[1.05] tracking-tight">
            ...
            <div className="flex flex-col gap-3 pt-2">
              <a
                ...
                className="bg-[#25D366] text-white px-6 py-3 rounded-lg hover:bg-[#25D366]/95 transition-all duration-300 hover:translate-y-[-1px] font-medium text-[15px] flex items-center justify-center gap-2"
              >
              ...
              <a
                ...
                className="border border-white/15 text-white px-6 py-3 rounded-lg hover:border-[#2F80FF]/60 hover:text-[#2F80FF] transition-all duration-300 hover:translate-y-[-1px] font-medium text-[15px] text-center"
              >
                Email Me
              </a>
            </div>
